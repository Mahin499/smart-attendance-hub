...
import {
  GraduationCap, LayoutDashboard, Users, UserPlus, Calendar,
  Camera, Settings, LogOut, ChevronLeft, ChevronRight, BarChart3, Clock
} from "lucide-react";
      ...
      >
        ...
        <div className="p-2 border-t border-sidebar-border space-y-1">
          <button
            ...
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-sidebar-foreground/70 hover:bg-sidebar-accent/50 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-sidebar-foreground/70 hover:bg-destructive/20 hover:text-destructive transition-colors"
          >
